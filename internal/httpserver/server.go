...
// WithTLSConfig sets the TLS configuration for the server. If provided, the server will accept TLS connections
// (HTTPS) with provided configuration. If nil, the server will only accept unencrypted HTTP connections.
func WithTLSConfig(cfg *tls.Config) Option { return func(s *Server) { s.srv.TLSConfig = cfg } }
...
func (s *Server) Serve(ctx context.Context, ln net.Listener) error {
	...
	// wrap the listener with TLS if TLSConfig is provided
