...
| `--public-url-root="…"`       | public URL root override for webhook URLs (e.g., https://example.com); if not set, the URL shown in the UI is based on the browser's location | string   |                              |      `PUBLIC_URL_ROOT`       |
